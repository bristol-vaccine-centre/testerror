...
%DIF DEL ../plos-resubmission/main.resubmission.tex   Thu Mar 21 11:33:36 2024
%DIF ADD ./main.technical-fixes.tex                   Tue Apr 16 18:03:22 2024
% Template for PLoS
...
\begin{figure}[!ht]
%DIF <  \centerline{\includegraphics{fig/fig1-testerror-v2.eps}}
%DIF >  \centerline{\includegraphics{Fig1.eps}}
...
\begin{figure}[hb!]
%DIF <  \centerline{\includegraphics{fig/fig2-low-prevalence-sensitivity-specificity.eps}}
%DIF >  \centerline{\includegraphics{Fig2.eps}}
...
\begin{figure}[ht!]
%DIF <  \centerline{\includegraphics{fig/fig4-impact-error-by-sensitivity-specificity.eps}}
%DIF >  \centerline{\includegraphics{Fig4.eps}}
...
\begin{figure}[hb!]
%DIF <  \centerline{\includegraphics[width = \textwidth]{fig/fig5-simulation-result-bayes-v2.eps}}
%DIF >  \centerline{\includegraphics[width = \textwidth]{Fig5.eps}}
...
%DIFAUXCMD
%DIFDELCMD < \label{S1_Appendix}
%DIFDELCMD < {\bf %%%
\DIFdel{Sensitivity and specificity of combined panel tests.}%DIFDELCMD < } %%%
...
%DIFAUXCMD
%DIFDELCMD < \label{S2_Appendix}
%DIFDELCMD < {\bf %%%
\DIFdel{Propagation of uncertainty of combined panel tests.}%DIFDELCMD < } %%%
...
\paragraph*{\DIFadd{S1 Appendix.}}
\label{S1_Appendix}
{\bf \DIFadd{Sensitivity and specificity of combined panel tests.}} \DIFadd{Derivation of the performance metrics and true prevalence adjustments for combination tests.
}

\paragraph*{\DIFadd{S2 Appendix.}}
\label{S2_Appendix}
{\bf \DIFadd{Propagation of uncertainty of combined panel tests.}} \DIFadd{Bayesian and frequentist approaches to estimating the uncertainty of panel test results.
}\DIFaddend 
